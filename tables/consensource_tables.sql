...
CREATE TYPE OrganizationType AS ENUM ('STANDARDS_BODY', 'CERTIFYING_BODY', 'FACTORY', 'INGESTION', 'UNSET_TYPE');
CREATE TYPE RequestStatus AS ENUM ('OPEN', 'IN_PROGRESS', 'CLOSED', 'CERTIFIED', 'UNSET_STATUS', 'PRE_CERTIFIED');
